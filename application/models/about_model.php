...
class About_model extends CI_Model {
	...
	public function get_info()
	{
		...
		$this->db->where('name', 'About Title');
		$data['about'] = $this->db->get('about');

		$this->db->where('name', 'About Overview');
		$data['about1'] = $this->db->get('about');

		$this->db->where('name', 'Mission');
		$data['about2'] = $this->db->get('about');

		$this->db->where('name', 'Core Values');
		$data['about3'] = $this->db->get('about');
